import { arrTypes } from './ranges';

const graphAdjacent = (adj: any) => (n: any) => ({ [n]: adj });
...
export { graphTypeNodes, graphTypesDepth1, graphTypesDepth2, graphBFS, graphBFSreverse, graphDFS };
