...
import { getPath } from '../coroutines/search';
import { dfs, bfs, dijkstra } from '../algorithm';
import { inputRange, arrAtoZ } from './mocks/ranges';
import { charDist } from '../heuristic';
import { graphDFS, graphBFS, graphTypesDepth1 } from './mocks/graphs';
...
describe('Dijkstra search', () => {
  ...
  it('handles different heuristic functions', () => {
    const customHeuristic = (a: string, b: string) => Math.abs(a.length - b.length);
